...
# Define the JWKS URL
jwks_url = "http://localhost:8080/.well-known/jwks.json"  # Replace with your actual URL
...
def authenticate():
    try:
        ...
        if 'expired' in request.args:
            private_key = current_private_key  # Use the current key even for expired tokens
            kid = current_key_id  # Use the Key ID for the current key
